    ...
    [587], {
        ...
        44: (e, t, s) => {
            ...
            function l(e, t) {
                ...
                return s.WebKitCSSMatrix ? (n = o.transform || o.webkitTransform, n.split(",").length > 6 && (n = n.split(", ").map((e => e.replace(",", "."))).join(", ")), a = new s.WebKitCSSMatrix("none" === n ? "" : n)) : (a = o.MozTransform || o.OTransform || o.MsTransform || o.msTransform || o.transform || o.getPropertyValue("transform").replace("translate(", "matrix(1, 0, 0, 1,"), r = a.toString().split(",")), "x" === t && (n = s.WebKitCSSMatrix ? a.m41 : 16 === r.length ? parseFloat(r[12]) : parseFloat(r[4])), "y" === t && (n = s.WebKitCSSMatrix ? a.m42 : 16 === r.length ? parseFloat(r[13]) : parseFloat(r[5])), n || 0
            }
        ...
        236: (e, t, s) => {
            ...
            var h = {
                updateSize: function() {
                    ...
                    let t, s;
                    const i = e.el;
                    t = void 0 !== e.params.width && null !== e.params.width ? e.params.width : i.clientWidth, s = void 0 !== e.params.height && null !== e.params.height ? e.params.height : i.clientHeight, 0 === t && e.isHorizontal() || 0 === s && e.isVertical() || (t = t - parseInt((0, r.m)(i, "padding-left") || 0, 10) - parseInt((0, r.m)(i, "padding-right") || 0, 10), s = s - parseInt((0, r.m)(i, "padding-top") || 0, 10) - parseInt((0, r.m)(i, "padding-bottom") || 0, 10), Number.isNaN(t) && (t = 0), Number.isNaN(s) && (s = 0), Object.assign(e, {
                        width: t,
                        height: s,
                ...
                updateSlides: function() {
                    ...
                    let T = s.spaceBetween,
                        ...
                        y = 0;
                    if (void 0 === a) return;
                    "string" == typeof T && T.indexOf("%") >= 0 ? T = parseFloat(T.replace("%", "")) / 100 * a : "string" == typeof T && (T = parseFloat(T)), e.virtualSize = -T, p.forEach((e => {
                    ...
                    for (let i = 0; i < u; i += 1) {
                        let n;
                        if (M = 0, p[i] && (n = p[i]), E && e.grid.updateSlide(i, n, p), !p[i] || "none" !== (0, r.m)(n, "display")) {
                            if ("auto" === s.slidesPerView) {
                                C && (p[i].style[e.getDirectionLabel("width")] = "");
                                const a = getComputedStyle(n),
                                    o = n.style.transform,
                                    l = n.style.webkitTransform;
                                if (o && (n.style.transform = "none"), l && (n.style.webkitTransform = "none"), s.roundLengths) M = e.isHorizontal() ? (0, r.f)(n, "width", !0) : (0, r.f)(n, "height", !0);
                                else {
                                    const e = t(a, "width"),
                                        s = t(a, "padding-left"),
                                        i = t(a, "padding-right"),
                            ...
                            } else M = (a - (s.slidesPerView - 1) * T) / s.slidesPerView, s.roundLengths && (M = Math.floor(M)), p[i] && (p[i].style[e.getDirectionLabel("width")] = `${M}px`);
                            p[i] && (p[i].swiperSlideSize = M), m.push(M), s.centeredSlides ? (b = b + M / 2 + x / 2 + T, 0 === x && 0 !== i && (b = b - a / 2 - T), 0 === i && (b = b - a / 2 - T), Math.abs(b) < .001 && (b = 0), s.roundLengths && (b = Math.floor(b)), y % s.slidesPerGroup == 0 && h.push(b), f.push(b)) : (s.roundLengths && (b = Math.floor(b)), (y - Math.min(e.params.slidesPerGroupSkip, y)) % e.params.slidesPerGroup == 0 && h.push(b), f.push(b), b = b + M + T), e.virtualSize += M + T, x = M, y += 1
                        }
                    }
                    if (e.virtualSize = Math.max(e.virtualSize, a) + g, o && l && ("slide" === s.effect || "coverflow" === s.effect) && (i.style.width = `${e.virtualSize+T}px`), s.setWrapperSize && (i.style[e.getDirectionLabel("width")] = `${e.virtualSize+T}px`), E && e.grid.updateWrapperSize(M, h), !s.centeredSlides) {
                        const t = [];
                    ...
                    if (Object.assign(e, {
                        ...
                        (0, r.s)(i, "--swiper-centered-offset-before", -h[0] + "px"), (0, r.s)(i, "--swiper-centered-offset-after", e.size / 2 - m[m.length - 1] / 2 + "px");
                        const t = -e.snapGrid[0],
                            s = -e.slidesGrid[0];
                        e.snapGrid = e.snapGrid.map((e => e + t)), e.slidesGrid = e.slidesGrid.map((e => e + s))
                    }
                    if (u !== c && e.emit("slidesLengthChange"), h.length !== w && (e.params.watchOverflow && e.checkOverflow(), e.emit("snapGridLengthChange")), f.length !== S && e.emit("slidesGridLengthChange"), s.watchSlidesProgress && e.updateSlidesOffset(), e.emit("slidesUpdated"), !(d || s.cssMode || "slide" !== s.effect && "fade" !== s.effect)) {
                ...
                updateSlidesClasses: function() {
                    const e = this,
                        ...
                        l = e => (0, r.e)(i, `.${s.slideClass}${e}, swiper-slide${e}`)[0];
                    let d, c, p;
                    if (t.forEach((e => {
                    ...
                    else o ? (d = t.filter((e => e.column === n))[0], p = t.filter((e => e.column === n + 1))[0], c = t.filter((e => e.column === n - 1))[0]) : d = t[n];
                    d && (d.classList.add(s.slideActiveClass), o ? (p && p.classList.add(s.slideNextClass), c && c.classList.add(s.slidePrevClass)) : (p = (0, r.o)(d, `.${s.slideClass}, swiper-slide`)[0], s.loop && !p && (p = t[0]), p && p.classList.add(s.slideNextClass), c = (0, r.p)(d, `.${s.slideClass}, swiper-slide`)[0], s.loop && 0 === !c && (c = t[t.length - 1]), c && c.classList.add(s.slidePrevClass))), e.emitSlidesClasses()
                },
                updateActiveIndex: function(e) {
                    ...
                    let h;
                    if (t.virtual && r.virtual.enabled && r.loop) h = c(d);
                    else if (p) {
                        const e = t.slides.filter((e => e.column === d))[0];
                        let s = parseInt(e.getAttribute("data-swiper-slide-index"), 10);
                        Number.isNaN(s) && (s = Math.max(t.slides.indexOf(e), 0)), h = Math.floor(s / r.grid.rows)
                    } else if (t.slides[d]) {
                    ...
                    Object.assign(t, {
                        ...
                        previousIndex: n,
                        activeIndex: d
                    }), t.initialized && u(t), t.emit("activeIndexChange"), t.emit("snapIndexChange"), (t.initialized || t.params.runCallbacksOnInit) && (a !== h && t.emit("realIndexChange"), t.emit("slideChange"))
                },
            ...
            var m = {
                    slideTo: function(e, t, s, i, n) {
                        ...
                        if (a.initialized && o !== u) {
                            if (!a.allowSlideNext && (h ? w > a.translate && w > a.minTranslate() : w < a.translate && w < a.minTranslate())) return !1;
                            if (!a.allowSlidePrev && w > a.translate && w > a.maxTranslate() && (u || 0) !== o) return !1
                        }
                        let S;
                        if (o !== (p || 0) && s && a.emit("beforeSlideChangeStart"), a.updateProgress(w), S = o > u ? "next" : o < u ? "prev" : "reset", h && -w === a.translate || !h && w === a.translate) return a.updateActiveIndex(o), l.autoHeight && a.updateAutoHeight(), a.updateSlidesClasses(), "slide" !== l.effect && a.setTranslate(w), "reset" !== S && (a.transitionStart(s, S), a.transitionEnd(s, S)), !1;
                        if (l.cssMode) {
                            ...
                            if (0 === t) {
                                ...
                                if (!a.support.smoothScroll) return (0, r.q)({
                                    swiper: a,
                                    targetPosition: s,
                                    side: e ? "left" : "top"
                                }), !0;
                        ...
                        return a.setTransition(t), a.setTranslate(w), a.updateActiveIndex(o), a.updateSlidesClasses(), a.emit("beforeTransitionStart", t, i), a.transitionStart(s, S), 0 === t ? a.transitionEnd(s, S) : a.animating || (a.animating = !0, a.onSlideToWrapperTransitionEnd || (a.onSlideToWrapperTransitionEnd = function(e) {
                    ...
                    slideToClickedSlide: function() {
                        ...
                        if (t.loop) {
                            ...
                            n = parseInt(e.clickedSlide.getAttribute("data-swiper-slide-index"), 10), t.centeredSlides ? a < e.loopedSlides - i / 2 || a > e.slides.length - e.loopedSlides + i / 2 ? (e.loopFix(), a = e.getSlideIndex((0, r.e)(s, `${o}[data-swiper-slide-index="${n}"]`)[0]), (0, r.n)((() => {
                                e.slideTo(a)
                            }))) : e.slideTo(a) : a > e.slides.length - i ? (e.loopFix(), a = e.getSlideIndex((0, r.e)(s, `${o}[data-swiper-slide-index="${n}"]`)[0]), (0, r.n)((() => {
                                e.slideTo(a)
                            }))) : e.slideTo(a)
                        } else e.slideTo(a)
                    }
                ...
                v = {
                    loopCreate: function(e) {
                        ...
                        l ? (s.loopAddBlankSlides ? (c(o - t.slides.length % o), t.recalcSlides(), t.updateSlides()) : (0, r.r)("Swiper Loop Warning: The number of slides is not even to slidesPerGroup, loop mode may not function properly. You need to add more slides (or make duplicates, or empty slides)"), n()) : d ? (s.loopAddBlankSlides ? (c(s.grid.rows - t.slides.length % s.grid.rows), t.recalcSlides(), t.updateSlides()) : (0, r.r)("Swiper Loop Warning: The number of slides is not even to grid.rows, loop mode may not function properly. You need to add more slides (or make duplicates, or empty slides)"), n()) : n(), t.loopFix({
                            slideRealIndex: e,
                    ...
                    loopFix: function(e) {
                        ...
                        c.length < v + w ? (0, r.r)("Swiper Loop Warning: The number of slides is not enough for loop mode, it will be disabled and not function properly. You need to add more slides (or make duplicates) or lower the values of slidesPerView and slidesPerGroup parameters") : S && "row" === f.grid.fill && (0, r.r)("Swiper Loop Warning: Loop mode is not compatible with grid.fill = `row`");
                        const T = [],
                            b = [];
                        let x = d.activeIndex;
                        void 0 === a ? a = d.getSlideIndex(c.filter((e => e.classList.contains(f.slideActiveClass)))[0]) : x = a;
                        const y = "next" === i || !i,
                            E = "prev" === i || !i;
                        let M = 0,
                            C = 0;
                        const P = S ? Math.ceil(c.length / f.grid.rows) : c.length,
                            I = (S ? c[a].column : a) + (m && void 0 === n ? -v / 2 + .5 : 0);
                        if (I < w) {
                            M = Math.max(w - I, g);
                        ...
                        if (d.__preventObserver__ = !0, requestAnimationFrame((() => {
                            ...
                            })), d.recalcSlides(), "auto" === f.slidesPerView ? d.updateSlides() : S && (T.length > 0 && E || b.length > 0 && y) && d.slides.forEach(((e, t) => {
                            ...
                            if (T.length > 0 && E) {
                                if (void 0 === t) {
                                    ...
                                    l ? d.setTranslate(d.translate - t) : (d.slideTo(x + M, 0, !1, !0), n && (d.touchEventsData.startTranslate = d.touchEventsData.startTranslate - t, d.touchEventsData.currentTranslate = d.touchEventsData.currentTranslate - t))
                                } else if (n) {
                            ...
                            if (void 0 === t) {
                                ...
                                l ? d.setTranslate(d.translate - t) : (d.slideTo(x - C, 0, !1, !0), n && (d.touchEventsData.startTranslate = d.touchEventsData.startTranslate - t, d.touchEventsData.currentTranslate = d.touchEventsData.currentTranslate - t))
                            } else {
            ...
            function w(e) {
                ...
                p && n.target && n.target.shadowRoot && u && (c = u[0]);
                ...
                Object.assign(a, {
                    ...
                    isScrolling: void 0,
                    startMoving: void 0
                }), l.startX = m, l.startY = v, a.touchStartTime = (0, r.d)(), t.allowClick = !0, t.updateSize(), t.swipeDirection = void 0, o.threshold > 0 && (a.allowThresholdMove = !1);
                let w = !0;
                ...
                const S = w && t.allowTouchMove && o.touchStartPreventDefault;
                !o.touchStartForcePreventDefault && !S || c.isContentEditable || n.preventDefault(), o.freeMode && o.freeMode.enabled && t.freeMode && t.animating && !o.cssMode && t.freeMode.onTouchStart(), t.emit("touchStart", n)
            }
            ...
            function S(e) {
                ...
                if (p.originalEvent && (p = p.originalEvent), "pointermove" === p.type) {
                    ...
                    if (p.pointerId !== n.pointerId) return
                }
                if ("touchmove" === p.type) {
                    if (c = [...p.changedTouches].filter((e => e.identifier === n.touchId))[0], !c || c.identifier !== n.touchId) return
                } else c = p;
                if (!n.isTouched) return void(n.startMoving && n.isScrolling && t.emit("touchMoveOpposite", p));
                const u = c.pageX,
                    h = c.pageY;
                if (p.preventedByNestedSwiper) return o.startX = u, void(o.startY = h);
                if (!t.allowTouchMove) return p.target.matches(n.focusableElements) || (t.allowClick = !1), void(n.isTouched && (Object.assign(o, {
                    startX: u,
                    startY: h,
                    currentX: u,
                    currentY: h
                ...
                if (a.touchReleaseOnEdges && !a.loop)
                    if (t.isVertical()) {
                        if (h < o.startY && t.translate <= t.maxTranslate() || h > o.startY && t.translate >= t.minTranslate()) return n.isTouched = !1, void(n.isMoved = !1)
                    } else if (u < o.startX && t.translate <= t.maxTranslate() || u > o.startX && t.translate >= t.minTranslate()) return;
                if (i.activeElement && p.target === i.activeElement && p.target.matches(n.focusableElements)) return n.isMoved = !0, void(t.allowClick = !1);
                n.allowTouchCallbacks && t.emit("touchMove", p), o.previousX = o.currentX, o.previousY = o.currentY, o.currentX = u, o.currentY = h;
                const f = o.currentX - o.startX,
                    m = o.currentY - o.startY;
                if (t.params.threshold && Math.sqrt(f ** 2 + m ** 2) < t.params.threshold) return;
                if (void 0 === n.isScrolling) {
                    let e;
                    t.isHorizontal() && o.currentY === o.startY || t.isVertical() && o.currentX === o.startX ? n.isScrolling = !1 : f * f + m * m >= 25 && (e = 180 * Math.atan2(Math.abs(m), Math.abs(f)) / Math.PI, n.isScrolling = t.isHorizontal() ? e > a.touchAngle : 90 - e > a.touchAngle)
                }
                if (n.isScrolling && t.emit("touchMoveOpposite", p), void 0 === n.startMoving && (o.currentX === o.startX && o.currentY === o.startY || (n.startMoving = !0)), n.isScrolling) return void(n.isTouched = !1);
                if (!n.startMoving) return;
                t.allowClick = !1, !a.cssMode && p.cancelable && p.preventDefault(), a.touchMoveStopPropagation && !a.nested && p.stopPropagation();
                let v = t.isHorizontal() ? f : m,
                ...
                const S = t.params.loop && !a.cssMode,
                    T = "next" === t.touchesDirection && t.allowSlideNext || "prev" === t.touchesDirection && t.allowSlidePrev;
                if (!n.isMoved) {
                    if (S && T && t.loopFix({
                    ...
                    n.allowMomentumBounce = !1, !a.grabCursor || !0 !== t.allowSlideNext && !0 !== t.allowSlidePrev || t.setGrabCursor(!0), t.emit("sliderFirstMove", p)
                }
                if ((new Date).getTime(), n.isMoved && n.allowThresholdMove && w !== t.touchesDirection && S && T && Math.abs(v) >= 1) return Object.assign(o, {
                    startX: u,
                    startY: h,
                    currentX: u,
                    currentY: h,
                ...
                t.emit("sliderMove", p), n.isMoved = !0, n.currentTranslate = v + n.startTranslate;
                let b = !0,
                    x = a.resistanceRatio;
                if (a.touchReleaseOnEdges && (x = 0), v > 0 ? (S && T && n.allowThresholdMove && n.currentTranslate > (a.centeredSlides ? t.minTranslate() - t.slidesSizesGrid[t.activeIndex + 1] : t.minTranslate()) && t.loopFix({
                        direction: "prev",
                        setTranslate: !0,
                        activeSlideIndex: 0
                    }), n.currentTranslate > t.minTranslate() && (b = !1, a.resistance && (n.currentTranslate = t.minTranslate() - 1 + (-t.minTranslate() + n.startTranslate + v) ** x))) : v < 0 && (S && T && n.allowThresholdMove && n.currentTranslate < (a.centeredSlides ? t.maxTranslate() + t.slidesSizesGrid[t.slidesSizesGrid.length - 1] : t.maxTranslate()) && t.loopFix({
                        direction: "next",
                        setTranslate: !0,
                        activeSlideIndex: t.slides.length - ("auto" === a.slidesPerView ? t.slidesPerViewDynamic() : Math.ceil(parseFloat(a.slidesPerView, 10)))
                    }), n.currentTranslate < t.maxTranslate() && (b = !1, a.resistance && (n.currentTranslate = t.maxTranslate() + 1 - (t.maxTranslate() - n.startTranslate - v) ** x))), b && (p.preventedByNestedSwiper = !0), !t.allowSlideNext && "next" === t.swipeDirection && n.currentTranslate < n.startTranslate && (n.currentTranslate = n.startTranslate), !t.allowSlidePrev && "prev" === t.swipeDirection && n.currentTranslate > n.startTranslate && (n.currentTranslate = n.startTranslate), t.allowSlidePrev || t.allowSlideNext || (n.currentTranslate = n.startTranslate), a.threshold > 0) {
            ...
            function T(e) {
                ...
                let h;
                if (s.isTouched = !1, s.isMoved = !1, s.startMoving = !1, h = a.followFinger ? l ? t.translate : -t.translate : -s.currentTranslate, a.cssMode) return;
                ...
                for (let e = 0; e < d.length; e += e < a.slidesPerGroupSkip ? 1 : a.slidesPerGroup) {
                    ...
                    void 0 !== d[e + t] ? (f || h >= d[e] && h < d[e + t]) && (m = e, v = d[e + t] - d[e]) : (f || h >= d[e]) && (m = e, v = d[d.length - 1] - d[d.length - 2])
                }
                let g = null,
                    w = null;
                ...
                if (u > a.longSwipesMs) {
                    ...
                    "next" === t.swipeDirection && (S >= a.longSwipesRatio ? t.slideTo(a.rewind && t.isEnd ? g : m + T) : t.slideTo(m)), "prev" === t.swipeDirection && (S > 1 - a.longSwipesRatio ? t.slideTo(m + T) : null !== w && S < 0 && Math.abs(S) > a.longSwipesRatio ? t.slideTo(w) : t.slideTo(m))
                } else {
                    if (!a.shortSwipes) return void t.slideTo(t.activeIndex);
                    !t.navigation || n.target !== t.navigation.nextEl && n.target !== t.navigation.prevEl ? ("next" === t.swipeDirection && t.slideTo(null !== g ? g : m + T), "prev" === t.swipeDirection && t.slideTo(null !== w ? w : m)) : n.target === t.navigation.nextEl ? t.slideTo(m + T) : t.slideTo(m)
                }
            }
            ...
            const C = (e, t) => {
                    const {
                        ...
                        wrapperEl: r,
                        device: n
                    } = e, a = i.ownerDocument, o = !!s.nested, l = "on" === t ? "addEventListener" : "removeEventListener", d = t;
                    a[l]("touchstart", e.onDocumentTouchStart, {
                        ...
                        passive: !0
                    }), (s.preventClicks || s.preventClicksPropagation) && i[l]("click", e.onClick, !0), s.cssMode && r[l]("scroll", e.onScroll), s.updateOnWindowResize ? e[d](n.ios || n.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", b, !0) : e[d]("observerUpdate", b, !0), i[l]("load", e.onLoad, {
                        capture: !0
                    })
                },
            ...
            const k = {
                    ...
                    events: {
                        attachEvents: function() {
                            ...
                            e.onTouchStart = w.bind(e), e.onTouchMove = S.bind(e), e.onTouchEnd = T.bind(e), e.onDocumentTouchStart = M.bind(e), t.cssMode && (e.onScroll = y.bind(e)), e.onClick = x.bind(e), e.onLoad = E.bind(e), C(e, "on")
                        },
                    ...
                    breakpoints: {
                        setBreakpoint: function() {
                            ...
                            const u = l.direction && l.direction !== i.direction,
                                ...
                                f = i.loop;
                            u && s && e.changeDirection(), (0, r.t)(e.params, l);
                            ...
                            }), p && !m ? e.disable() : !p && m && e.enable(), e.currentBreakpoint = o, e.emit("_beforeBreakpoint", l), s && (h ? (e.loopDestroy(), e.loopCreate(t), e.updateSlides()) : !f && v ? (e.loopCreate(t), e.updateSlides()) : f && !v && e.loopDestroy()), e.emit("breakpoint", l)
                        },
            ...
            class A {
                constructor() {
                    let e, t;
                    for (var s = arguments.length, n = new Array(s), d = 0; d < s; d++) n[d] = arguments[d];
                    1 === n.length && n[0].constructor && "Object" === Object.prototype.toString.call(n[0]).slice(8, -1) ? t = n[0] : [e, t] = n, t || (t = {}), t = (0, r.t)({}, t), e && !t.el && (t.el = e);
                    const c = (0, i.g)();
                    ...
                    const p = this;
                    var u;
                    p.__swiper__ = !0, p.support = l(), p.device = (void 0 === (u = {
                        ...
                        const h = a.match(/(iPod)(.*OS\s([\d_]+))?/),
                            ...
                            m = "Win32" === n;
                        let v = "MacIntel" === n;
                        return !u && v && s.touch && ["1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810"].indexOf(`${d}x${c}`) >= 0 && (u = a.match(/(Version)\/([\d.]+)/), u || (u = [0, 1, "13_0_0"]), v = !1), p && !m && (o.os = "android", o.android = !0), (u || f || h) && (o.os = "ios", o.ios = !0), o
                    }(u)), a), p.browser = (o || (o = function() {
                        const e = (0, i.a)();
                        let t = !1;
                    ...
                    const f = (0, r.t)({}, I, h);
                    return p.params = (0, r.t)({}, f, O, t), p.originalParams = (0, r.t)({}, p.params), p.passedParams = (0, r.t)({}, t), p.params && p.params.on && Object.keys(p.params.on).forEach((e => {
                ...
                getSlideIndex(e) {
                    const {
                        slidesEl: t,
                        params: s
                    } = this, i = (0, r.e)(t, `.${s.slideClass}, swiper-slide`), n = (0, r.g)(i[0]);
                    return (0, r.g)(e) - n
                }
                ...
                mount(e) {
                    ...
                    let n = s && s.shadowRoot && s.shadowRoot.querySelector ? s.shadowRoot.querySelector(i()) : (0, r.e)(s, i())[0];
                    return !n && t.params.createElements && (n = (0, r.c)("div", t.params.wrapperClass), s.append(n), (0, r.e)(s, `.${t.params.slideClass}`).forEach((e => {
                        ...
                        mounted: !0,
                        rtl: "rtl" === s.dir.toLowerCase() || "rtl" === (0, r.m)(s, "direction"),
                        rtlTranslate: "horizontal" === t.params.direction && ("rtl" === s.dir.toLowerCase() || "rtl" === (0, r.m)(s, "direction")),
                        wrongRTL: "-webkit-box" === (0, r.m)(n, "display")
                    }), !0
                }
                init(e) {
                    const t = this;
                ...
                destroy(e, t) {
                    ...
                    return void 0 === s.params || s.destroyed || (s.emit("beforeDestroy"), s.initialized = !1, s.detachEvents(), i.loop && s.loopDestroy(), t && (s.removeClasses(), n.removeAttribute("style"), a.removeAttribute("style"), o && o.length && o.forEach((e => {
                        ...
                        s.off(e)
                    })), !1 !== e && (s.el.swiper = null, (0, r.u)(s)), s.destroyed = !0), null
                }
